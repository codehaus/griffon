...
public abstract class PathSegment {
	public static void main(String[] args) {
		Float moveTo = new Float(0,0);
		Float curveTo = moveTo.cubicTo(0, 20, 50, 50, 50, 50);
		for(double d = -.1; d<1.1; d+=.05) {
			System.out.println("getTheta( "+d+", false): "+curveTo.getTheta((float)d,false));
		}
	}
