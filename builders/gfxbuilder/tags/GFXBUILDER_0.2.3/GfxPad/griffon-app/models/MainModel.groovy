...
class MainModel {
   ...
   @Bindable String exportAsImageFile
   @Bindable boolean exportAsImageBorder = true

   @Bindable int exportAsSvgWidth
   @Bindable int exportAsSvgHeight
   @Bindable String exportAsSvgFile
