...
public class SwingxtrasBuilder extends SwingBuilder {
   ...
   public void registerL2fprod() {
      ...
      registerBeanFactory("buttonBar", JButtonBar)
      registerFactory("linkButton", new RichActionWidgetFactory(JLinkButton))
      registerBeanFactory("tipOfTheDay", JTipOfTheDay)
      registerBeanFactory("defaultTipModel", DefaultTipModel)
      registerBeanFactory("defaultTip", DefaultTip)
      registerBeanFactory("taskPaneGroup", JTaskPaneGroup)
      registerBeanFactory("taskPane", JTaskPane)
      ...
      registerBeanFactory("propertySheetPanel", PropertySheetPanel)
