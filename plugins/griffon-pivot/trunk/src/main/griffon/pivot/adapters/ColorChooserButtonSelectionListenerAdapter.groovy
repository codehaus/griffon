 ...
 */
class ColorChooserButtonSelectionListenerAdapter extends BuilderDelegate implements ColorChooserButtonSelectionListener {
    private Closure onSelectedColorChanged
 
    ColorChooserButtonSelectionListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void selectedColorChanged(ColorChooserButton arg0, Color arg1) {
