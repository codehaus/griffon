 ...
 */
class CardPaneListenerAdapter extends BuilderDelegate implements CardPaneListener {
    ...
    CardPaneListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    Vote previewSelectedIndexChange(CardPane arg0, int arg1) {
        if(onPreviewSelectedIndexChange) onPreviewSelectedIndexChange(arg0, arg1); else Vote.APPROVE
    }

    void selectedIndexChanged(CardPane arg0, int arg1) {
        if(onSelectedIndexChanged) onSelectedIndexChanged(arg0, arg1)
    }

    void selectedIndexChangeVetoed(CardPane arg0, Vote arg1) {
