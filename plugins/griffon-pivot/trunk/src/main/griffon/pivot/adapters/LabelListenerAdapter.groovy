 ...
 */
class LabelListenerAdapter extends BuilderDelegate implements LabelListener {
    private Closure onTextChanged
    private Closure onTextKeyChanged
 
    LabelListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void textChanged(Label arg0, String arg1) {
        if(onTextChanged) onTextChanged(arg0, arg1)
    }

    void textKeyChanged(Label arg0, String arg1) {
