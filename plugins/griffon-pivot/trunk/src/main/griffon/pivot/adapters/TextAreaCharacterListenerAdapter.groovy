 ...
 */
class TextAreaCharacterListenerAdapter extends BuilderDelegate implements TextAreaCharacterListener {
    private Closure onCharactersInserted
    private Closure onCharactersRemoved
 
    TextAreaCharacterListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void charactersInserted(TextArea arg0, int arg1, int arg2) {
        if(onCharactersInserted) onCharactersInserted(arg0, arg1, arg2)
    }

    void charactersRemoved(TextArea arg0, int arg1, int arg2) {
