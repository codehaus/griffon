 ...
 */
class TextInputCharacterListenerAdapter extends BuilderDelegate implements TextInputCharacterListener {
    private Closure onCharactersInserted
    private Closure onCharactersRemoved
 
    TextInputCharacterListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void charactersInserted(TextInput arg0, int arg1, int arg2) {
        if(onCharactersInserted) onCharactersInserted(arg0, arg1, arg2)
    }

    void charactersRemoved(TextInput arg0, int arg1, int arg2) {
