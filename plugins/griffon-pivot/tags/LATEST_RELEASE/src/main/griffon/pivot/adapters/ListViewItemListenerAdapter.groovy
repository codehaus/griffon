 ...
 */
class ListViewItemListenerAdapter extends BuilderDelegate implements ListViewItemListener {
    ...
    ListViewItemListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void itemInserted(ListView arg0, int arg1) {
        if(onItemInserted) onItemInserted(arg0, arg1)
    }

    void itemUpdated(ListView arg0, int arg1) {
        if(onItemUpdated) onItemUpdated(arg0, arg1)
    }

    void itemsRemoved(ListView arg0, int arg1, int arg2) {
        if(onItemsRemoved) onItemsRemoved(arg0, arg1, arg2)
    }

    void itemsCleared(ListView arg0) {
        if(onItemsCleared) onItemsCleared(arg0)
    }

    void itemsSorted(ListView arg0) {
