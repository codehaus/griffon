 ...
 */
class MenuPopupListenerAdapter extends BuilderDelegate implements MenuPopupListener {
    private Closure onMenuChanged
 
    MenuPopupListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void menuChanged(MenuPopup arg0, Menu arg1) {
