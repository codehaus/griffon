 ...
 */
class ComponentMouseWheelListenerAdapter extends BuilderDelegate implements ComponentMouseWheelListener {
    private Closure onMouseWheel
 
    ComponentMouseWheelListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    boolean mouseWheel(Component arg0, ScrollType arg1, int arg2, int arg3, int arg4, int arg5) {
