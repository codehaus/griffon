 ...
 */
class TooltipListenerAdapter extends BuilderDelegate implements TooltipListener {
    private Closure onTextChanged
 
    TooltipListenerAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void textChanged(Tooltip arg0, String arg1) {
