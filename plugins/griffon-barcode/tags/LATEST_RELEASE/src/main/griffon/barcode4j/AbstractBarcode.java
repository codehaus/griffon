...
public abstract class AbstractBarcode extends JComponent {
    ...
    public void initBarcodeGenerator(String type) {
        if (type == null) {
        ...
        if (!lastType.equals(type)) {
            ...
            try {
                ...
                this.bargen = (AbstractBarcodeBean)clazz.newInstance();
                ((AbstractBarcodeBean)this.bargen).doQuietZone(true);
            } catch (Exception e) {
