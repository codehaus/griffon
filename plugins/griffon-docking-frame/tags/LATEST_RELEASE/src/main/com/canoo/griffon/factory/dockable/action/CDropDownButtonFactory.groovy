 ...
 */
class CDropDownButtonFactory extends CDecorateableActionFactory {
    CDropDownButtonFactory() {
        super(CDropDownButton, false)
    }

    @Override
    createInstance(Map attributes) {
        return new CDropDownButton()
    }
