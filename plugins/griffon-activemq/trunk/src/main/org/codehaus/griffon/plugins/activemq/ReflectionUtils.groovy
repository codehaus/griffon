 ...
 */
package org.codehaus.griffon.plugins.activemq

import griffon.util.ApplicationHolder as AH
...
class ReflectionUtils {
  ...
  static ConfigObject getConfig() { AH.application.config.griffon.plugins.activemq }

  static void setConfig(ConfigObject c) { AH.application.config.griffon.plugins.activemq = c }
