 ...
 */
public class DefaultGriffonLdapSchemaClass extends DefaultGriffonClass implements GriffonLdapSchemaClass {
    public DefaultGriffonLdapSchemaClass(GriffonApplication app, Class clazz) {
        super(app, clazz, GriffonLdapSchemaClass.TYPE, GriffonLdapSchemaClass.TRAILING);
    }
}
