...
if(addonIsSet1) {
    ...
    builderConfigFile1.text = builderConfigFile1.text - "root.'griffon.builder.css.CSSBuilder'.view = '*'\n"
    builderConfigFile1.text = builderConfigFile1.text - "root.'griffon.builder.css.CSSBuilder'.controller = ['CSS']\n"
}
