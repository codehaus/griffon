 ...
 *
 * @author <a href='mailto:beckwithb@studentsonly.com'>Burt Beckwith</a> (Grails 0.3.2)
 * @author Sergey Nebolsin (Grails 0.3.2)
 */
public class JobDetailFactoryBean implements FactoryBean, InitializingBean {
    public static final transient String JOB_NAME_PARAMETER = "org.griffon.plugins.quartz.griffonJobName"; 
    ...
    public void afterPropertiesSet() {
        ...
        Class jobClass = (concurrent ? GriffonJobFactory.GriffonJobWrapper.class : GriffonJobFactory.StatefulGriffonJobWrapper.class);
