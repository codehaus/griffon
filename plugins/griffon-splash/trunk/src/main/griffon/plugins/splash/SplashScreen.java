 ...
 * startup.  Usage is straight forward: simply construct a
 * SplashScreen at the start of main ( ) and call its splash ()
 * method. Proceed with startup as normal.Use showStatus ( String ) f
 * or reporting progress during startup.  Finally , at the
...
public class SplashScreen implements ImageObserver {
	...
	public void splash() {
		if (image != null)
			...
			splash(Toolkit.getDefaultToolkit().getImage("splash.png")); // async
	}
	 ...
	 * viewed as user i n t e r f a c e c r u f t ! Please use wi th care. </blockquote>
	 */
