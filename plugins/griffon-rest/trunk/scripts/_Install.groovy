...
// check to see if we already have a RestGriffonAddon
...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'RestGriffonAddon' == builder
    }
}

if (!addonIsSet1) {
    println 'Adding RestGriffonAddon to Builder.groovy'
...
if(!(appConfig.flatten().'griffon.rest.injectInto')) {
