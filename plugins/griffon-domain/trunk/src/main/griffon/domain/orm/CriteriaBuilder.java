...
public final class CriteriaBuilder extends FactoryBuilderSupport {
    ...
    private static class CriterionFactory extends AbstractFactory {
        ...
        public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map properties)
            ...
            switch(operator) {
                case EQUAL: return Restrictions.eq(name.toString(), value);
                case NOT_EQUAL: return Restrictions.ne(name.toString(), value);
                case GREATER_THAN: return Restrictions.gt(name.toString(), value);
                case GREATER_THAN_OR_EQUAL: return Restrictions.ge(name.toString(), value);
                case LESS_THAN: return Restrictions.lt(name.toString(), value);
                case LESS_THAN_OR_EQUAL: return Restrictions.le(name.toString(), value);
                case LIKE: return Restrictions.like(name.toString(), value);
                case NOT_LIKE: return Restrictions.notLike(name.toString(), value);
            }
