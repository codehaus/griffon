...
import org.codehaus.griffon.runtime.domain.methods.AbstractFindAllPersistentMethod
import org.codehaus.griffon.runtime.domain.methods.AbstractFetchPersistentMethod

class SampleDomainHandler implements GriffonDomainHandler {
...
class SampleFetchMethod extends AbstractFetchPersistentMethod {
    SampleFetchMethod(GriffonDomainHandler domainHandler) {
        super(domainHandler)
    }
...
class SampleFindAllMethod extends AbstractFindAllPersistentMethod {
    SampleFindAllMethod(GriffonDomainHandler domainHandler) {
        super(domainHandler)
    }
