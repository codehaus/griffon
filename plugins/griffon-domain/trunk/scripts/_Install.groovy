...
// check to see if we already have a DomainGriffonAddon
...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'DomainGriffonAddon' == builder
    }
}

if (!addonIsSet1) {
    println 'Adding DomainGriffonAddon to Builder.groovy'
