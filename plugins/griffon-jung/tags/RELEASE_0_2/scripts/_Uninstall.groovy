...
// check to see if we already have a JungGriffonAddon
...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'JungGriffonAddon' == builder
    }
}

if(addonIsSet1) {
    def builderConfigFile1 = new File("${basedir}/griffon-app/conf/Builder.groovy")
    builderConfigFile1.text = builderConfigFile1.text - "root.'JungGriffonAddon'.addon=true\n"
}
