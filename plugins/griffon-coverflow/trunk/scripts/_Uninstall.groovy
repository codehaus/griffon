...
// check to see if we already have a CoverflowGriffonAddon
...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'CoverflowGriffonAddon' == builder
    }
}

if(addonIsSet1) {
    def builderConfigFile1 = new File("${basedir}/griffon-app/conf/Builder.groovy")
    builderConfigFile1.text = builderConfigFile1.text - "root.'CoverflowGriffonAddon'.addon=true\n"
}
