 ...
 * <p>
 * This is the default {@code WindowDisplayHandler} used by {@code SWTApplication}. It expects a configuration entry in
...
public class ConfigurableWindowDisplayHandler implements WindowDisplayHandler {
    ...
    private void run(Object obj, Shell window, GriffonApplication application) {
    ...
    private Map<String, Object> windowManagerBlock(GriffonApplication application) {
        Map<String, Object> block = (Map<String, Object>)ConfigUtils.getConfigValue(application.getConfig(), "swt.windowManager");
