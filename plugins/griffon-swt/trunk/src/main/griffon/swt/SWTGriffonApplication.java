 ...
 * <p>
 * Windows in a SWT application should be handled by a {@code WindowManager}, which in turn requires a concrete implementation of the
 * {@code WindowDisplayHandler} to be available on the target application.
 * 
 * @author Andres Almiray
 * @see griffon.swt.WindowManager
 * @see griffon.swt.WindowDisplayHandler
 */
public interface SWTGriffonApplication extends GriffonApplication {
    /**
