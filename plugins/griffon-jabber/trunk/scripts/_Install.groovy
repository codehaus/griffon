...
// check to see if we already have a JabberGriffonAddon
...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'JabberGriffonAddon' == builder
    }
}

if (!addonIsSet1) {
    println 'Adding JabberGriffonAddon to Builder.groovy'
...
if(!(appConfig.flatten().'griffon.jabber.injectInto')) {
