...
// check to see if we already have a FeedsGriffonAddon
...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'FeedsGriffonAddon' == builder
    }
}

if (addonIsSet1) {
    println 'Removing FeedsGriffonAddon from Builder.groovy'
    def builderConfigFile1 = new File("${basedir}/griffon-app/conf/Builder.groovy")
    builderConfigFile1.text = builderConfigFile1.text - "root.'FeedsGriffonAddon'.addon=true\n"
}
