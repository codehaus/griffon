...
slurpedBuilder1.each() { prefix, v ->
    v.each { builder, views ->
        addonIsSet1 = addonIsSet1 || 'griffon.builder.gfx.GfxBuilder' == builder
    }
}

if(addonIsSet1) {
    def builderConfigFile1 = new File("${basedir}/griffon-app/conf/Builder.groovy")
    builderConfigFile1.text = builderConfigFile1.text - "root.'griffon.builder.gfx.GfxBuilder'.view = '*'\n"
}
