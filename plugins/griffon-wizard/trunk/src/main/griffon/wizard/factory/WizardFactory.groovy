...
package griffon.wizard.factory
...
import griffon.wizard.impl.GriffonBranchingWizard
import griffon.wizard.impl.GriffonWizardPage
...
class WizardFactory extends AbstractFactory {
    ...
    GriffonWizardPanelProvider handleWizardPanelProvider(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
        ...
        // def wppd = builder.app.newInstance(val as Class, 'wizardPanelProvider')
        def wppd = newArtifactInstance(builder, val as Class, 'wizardPanelProvider')
        ...
        if(pages instanceof List) {
            if(pages.every{ it instanceof String }) {
                ...
                if(!n.endsWith('WizardPage')) n += 'WizardPage'
                    // def pd = builder.app.newInstance(n as Class, 'wizardPage')
                    def pd = newArtifactInstance(builder, n as Class, 'wizardPage')
...
class BranchingWizardFactory extends WizardFactory {
    Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes)
       ...
       // def bw = builder.app.newInstance(val as Class, 'branchingWizard')
       def bw = newArtifactInstance(builder, val as Class, 'branchingWizard')
       bw.builder = builder
