 ...
 */
class EditableChangedAdapter extends BuilderDelegate implements Changed {
    private Closure onChangedClosure

    EditableChangedAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
