...
import org.gnome.gtk.SpinButton.ValueChanged

/**
 * @author Andres Almiray
 */
class SpinButtonValueChangedAdapter extends BuilderDelegate implements ValueChanged {
    private Closure onValueChangedClosure

    SpinButtonValueChangedAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onValueChanged(SpinButton arg0) {
