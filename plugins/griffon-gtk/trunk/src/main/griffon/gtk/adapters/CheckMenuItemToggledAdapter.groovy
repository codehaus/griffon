 ...
 */
class CheckMenuItemToggledAdapter extends BuilderDelegate implements Toggled {
    private Closure onToggledClosure

    CheckMenuItemToggledAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onToggled(CheckMenuItem arg0) {
