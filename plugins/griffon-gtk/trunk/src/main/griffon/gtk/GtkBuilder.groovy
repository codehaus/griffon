...
class GtkBuilder extends FactoryBuilderSupport {
    ...
    void registerGtk() {
        ...
        registerGtkComponentFactory('hseparator', HSeparator)
        ...
        registerGtkComponentFactory('vseparator', VSeparator)
        ...
        registerGtkContainerFactory('checkMenuItem', CheckMenuItem)
        ...
        registerGtkContainerFactory('imageMenuItem', ImageMenuItem)
        registerGtkContainerFactory('layout', Layout)
        registerGtkContainerFactory('linkButton', LinkButton)
        registerGtkContainerFactory('menu', Menu)
        registerGtkContainerFactory('menuBar', MenuBar)
        registerGtkContainerFactory('menuItem', MenuItem)
        ...
        registerGtkContainerFactory('radioMenuItem', RadioMenuItem)
        ...
        registerGtkContainerFactory('separatorMenuItem', SeparatorMenuItem)
        registerGtkContainerFactory('separatorToolItem', SeparatorToolItem)
