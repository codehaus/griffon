 ...
 */
class StatusIconActivateAdapter extends BuilderDelegate implements Activate {
    private Closure onActivateClosure

    StatusIconActivateAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onActivate(StatusIcon arg0) {
