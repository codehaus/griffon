 ...
 */
class ComboBoxChangedAdapter extends BuilderDelegate implements Changed {
    private Closure onChangedClosure

    ComboBoxChangedAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
