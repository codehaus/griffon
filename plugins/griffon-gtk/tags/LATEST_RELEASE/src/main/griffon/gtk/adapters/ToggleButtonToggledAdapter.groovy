 ...
 */
class ToggleButtonToggledAdapter extends BuilderDelegate implements Toggled {
    private Closure onToggledClosure

    ToggleButtonToggledAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onToggled(ToggleButton arg0) {
