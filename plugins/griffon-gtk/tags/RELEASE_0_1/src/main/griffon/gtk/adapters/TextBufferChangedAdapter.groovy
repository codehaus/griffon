...
import org.gnome.gtk.TextBuffer.Changed

/**
 * @author Andres Almiray
 */
class TextBufferChangedAdapter extends BuilderDelegate implements Changed {
    private Closure onChangedClosure

    TextBufferChangedAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onChanged(TextBuffer arg0) {
