...
import org.gnome.gtk.Adjustment.Changed

/**
 * @author Andres Almiray
 */
class AdjustmentChangedAdapter extends BuilderDelegate implements Changed {
    private Closure onChangedClosure

    AdjustmentChangedAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onChanged(Adjustment arg0) {
