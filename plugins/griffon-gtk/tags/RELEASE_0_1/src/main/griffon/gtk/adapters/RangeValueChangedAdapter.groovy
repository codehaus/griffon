 ...
 */
class RangeValueChangedAdapter extends BuilderDelegate implements ValueChanged {
    private Closure onValueChangedClosure

    RangeValueChangedAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onValueChanged(Range arg0) {
