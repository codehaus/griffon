 ...
 */
class ToggleToolButtonToggledAdapter extends BuilderDelegate implements Toggled {
    private Closure onToggledClosure

    ToggleToolButtonToggledAdapter(FactoryBuilderSupport builder) {
        super(builder)
    }
    ...
    void onToggled(ToggleToolButton arg0) {
        if(onToggledClosure) onToggledClosure.call(arg0)
    }
}