...
import griffon.charva.CharvaBuilder
import griffon.charva.binding.*
import java.util.Map.Entry
import org.codehaus.groovy.binding.*

/**
 * @author <a href="mailto:shemnon@yahoo.com">Danno Ferrin</a>
 * @version $Revision: 17029 $
 * @since Groovy 1.1
 */
public class BindFactory extends AbstractCharvaFactory {
    ...
    public bindingAttributeDelegate(FactoryBuilderSupport builder, def node, def attributes) {
        ...
        while (iter.hasNext()) {
            ...
            def idAttr = builder.getAt(CharvaBuilder.DELEGATE_PROPERTY_OBJECT_ID) ?: CharvaBuilder.DEFAULT_DELEGATE_PROPERTY_OBJECT_ID
