 ...
 *
 * @see griffon.charva.WindowDisplayHandler
 *
 * @author Andres Almiray
 */
public final class WindowManager implements ShutdownHandler {
    private final CharvaGriffonApplication app;
     ...
     */
    public WindowManager(CharvaGriffonApplication app) {
        this.app = app;
    }
     ...
     * The WindowManager expects a configuration flag <code>charva.windowManager.startingWindow</code>. If it's not 
    ...
    public Window getStartingWindow() {
        Object value = fetchConfigProperty(fetchConfigProperty(app.getConfig(), "charva"), "windowManager").getProperty("startingWindow");
